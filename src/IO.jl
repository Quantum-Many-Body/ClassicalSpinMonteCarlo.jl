...
function writeMonteCarlo(filename::String, mc::MonteCarlo{Lattice{D}}) where {D}
    h5open(filename, "w") do f
        ...
        f["mc/observables/energyDensity/error"] = vars(mc.observables.energy)[1]
        ...
        f["mc/observables/lattice/last/spins"] = mc.lattice.spins
